...
class OrganizationPage extends StatefulWidget {
  const OrganizationPage({super.key, required this.organizationId});
...
class _OrganizationPageState extends State<OrganizationPage> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    myOrganizationCubit.getSomeOrganization(widget.organizationId);
    _tabController = TabController(length: 3, vsync: this);

    activeZboryCubit.getActveZboryByOrganizationId(widget.organizationId);
    inactiveZboryCubit.getInactveZboryByOrganizationId(widget.organizationId);
                  ...
                  itemBuilder: (context, index) {
                    return ZbirCard(
                      ...
                      collectionGoalAmount:
                          double.parse(state.zboryModel.results![index].goalAmount),
                    );
                  },
